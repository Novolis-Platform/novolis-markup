...
public static class GithubSmileyDefinitions
{
    ...
    public const string Flush = ":flushed:";
    public const string Frown = ":frowning:";
    ...
    public const string MoneyMouth = ":money_mouth:";
